...
vector<TDenseMatrix> MinusLogPosterior::P_0; 
TDenseVector MinusLogPosterior::initial_prob; 

void * MinusLogPosterior::function(int *mode, int *n, double *x_array, double *f, double *g, int *nstate)
{
...
int CMSSM::Maximize_LogPosterior(double &log_posterior_optimal, TDenseVector &x_optimal, const vector<TDenseVector> &y, const vector<TDenseVector> &z_0, const vector<TDenseMatrix> &P_0, const TDenseVector &initial_prob, const TDenseVector &x0) 
// Returns
...
// 	>=0:	inform code returned by npsol_
{
	...
	MinusLogPosterior::model = this; 
	MinusLogPosterior::y = y; 
	MinusLogPosterior::z_0 = z_0; 
	MinusLogPosterior::P_0 = P_0; 
	MinusLogPosterior::initial_prob = initial_prob; 
	...
	npsol_(&n, &nclin, &ncnln, &ldA, &ldJ, &ldR, A, bl, bu, NULL, MinusLogPosterior::function, &inform, &iter, istate, c, cJac, clambda, &f, g, R, x_raw, iw, &leniw, w, &lenw); 
